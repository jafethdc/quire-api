  ...
  describe 'POST #create' do
    context 'when valid parameters are passed' do
      it 'renders the json representation for the user record just created' do
        ...
        post :create, params: { user: user_attrs.slice(:last_location, :fb_user_id), fb_access_token: 'token' }, format: :json
    ...
    context 'when no valid fb access token is provided' do
      it 'renders an errors json' do
        ...
        post :create, params: { user: invalid_user_attributes.slice(:last_location, :fb_user_id) }, format: :json
        expect(json_response).to have_key(:errors)
      end
